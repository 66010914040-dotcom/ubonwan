...
<head>
    ...
    <title>อุบลวรรณ ลีล้าน้อย พรีม - รายการสินค้า</title>
...
<div class="container">
    <div class="table-container">
        <h1 class="mb-4 text-primary">อุบลวรรณ ลีล้าน้อย พรีม</h1>
        ...
        <table id="myTable" class="table table-striped table-hover" style="width:100%">
            ...
            ?>
                <tr>
                    ...
                    <td align="right"><strong><?php echo number_format($data['p_amount'], 2);?></strong></td>
                    <td align="center">
