    ...
    <div class="container mt-5 mb-5">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h1 class="h4 mb-0">ฟอร์มรับข้อมูล - อุบลวรรณ ลีล้าน้อย (พรีม) </h1>
            </div>
            <div class="card-body">
        ...
        if (isset($_POST['Submit'])) {
			...
			$sql = "INSERT INTO register (r_id, r_name, r_phone, r_heigth , r_address, 	r_birthday,r_color, r_major ) VALUES (NULL, '{$fullname}', '{$phone}', '{$heigth}', '{$address}', '{$birthday}', '{$color}', '{$major}');";
